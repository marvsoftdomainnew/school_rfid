...
import '../staff/controller/staff_attendance_list_controller.dart';
...
class DashboardBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<StudentAttendanceListController>(() => StudentAttendanceListController(),);
    Get.lazyPut<StaffAttendanceListController>(() => StaffAttendanceListController(),);
  }
}
